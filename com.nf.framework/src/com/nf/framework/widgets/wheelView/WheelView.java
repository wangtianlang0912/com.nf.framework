...
package com.nf.framework.widgets.wheelView;
...
public class WheelView extends View
{
    ...
    private void initResourcesIfNecessary()
    {
        ...
        {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.common_wheel_val);
        }
        ...
        setBackgroundResource(R.drawable.common_wheel_bg);
    }
