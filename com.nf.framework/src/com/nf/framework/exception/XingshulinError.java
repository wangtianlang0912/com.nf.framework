 ...
 * @author niufei
 */
public class XingshulinError extends RuntimeException {
    ...
    /** 错误码：初始化失败 */
    public static final int ERROR_INIT_ERROR = -10;
    
    /***当前sd卡不存在**/
    public static final int ERROR_SdCard_EXIST = -11;
    /***当前sd卡不能写入**/
    public static final int ERROR_SdCard_WRITE = -12;
	/**
	 * 服务器返回的错误代码
	 */
	...
	public XingshulinError() {
		super();
	}
	public XingshulinError(String errorMessage) {
//		super(errorMessage);
	}
	public XingshulinError(Throwable ex){
//		super(ex);
//		ex.getStackTrace();
		LogUtil.writeExceptionLog(null, ex);
	}
	public XingshulinError(Context context ,Throwable ex){
		super(ex);
//		ex.getStackTrace();
		LogUtil.writeExceptionLog(context, ex);
	}
	public XingshulinError(int errorCode, String errorMessage) {
		super(errorMessage);
		this.errorCode = errorCode;
	}

	public XingshulinError(int errorCode, String errorMessage, String orgResponse) {
		super(errorMessage);
		this.errorCode = errorCode;
